...
- **`index.html`** — the **primary** deliverable. The **Motadata-native** profiling design: continuous-profile list → service/process detail → method hotspots → interactive flame-graph workspace → compare.
